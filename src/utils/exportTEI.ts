...
<TEI xmlns="http://www.tei-c.org/ns/1.0">
  <teiHeader>
    ...
    <encodingDesc>
      <appInfo>
        <application ident="ndlocr-lite-web-ai" version="0.10.5">
...
/**
 * 複数のOCR結果をまとめた単一のTEI XMLファイルとしてダウンロード
 */
export function downloadBatchTEI(results: OCRResult[], batchName?: string): void {
  const now = new Date().toISOString()
